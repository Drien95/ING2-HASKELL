...
main = do
 -- Générez l'arbre de compression à partir de la source
    ...
    let entrop = entropy exampleSource
    ...
    case compressTree of
        (Just encodingTree, encodedSymbols) -> do
            ...
            let totlength = count encodingTree
        ...
        (Nothing, _) -> putStrLn "Impossible de créer l'arbre de compression"
    ...
    putStrLn $ "Entropie de la source : " ++ show entrop
